...
class NutrientCalculations:
    ...
    def search_food_name(this, search_query):
        ...
        return: list of dictionaries. each dictionary contains food_name.
...
# example of foods that user selected that they ate
    ...
    food_names = nutrient_calculations.search_food_name("Fuji Apple")
    foods_user_ate = {"Fuji Apple": 2, "Gala Apple": 5, "Lime": 1, "Cranberry": 3, "Poached Egg": 5, 
